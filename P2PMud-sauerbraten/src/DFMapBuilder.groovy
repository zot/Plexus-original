				...
				for (def j = 0; j < cols; j += rle) {
					...
					if (first != '$') {
						...
						if (first == 'f') {
							...
							sauer('wall1', "selcube $x $y $z $len 1 2 $cubesize 5; $texture")
							remipCount += rle
						}else if (first == 'w') {
